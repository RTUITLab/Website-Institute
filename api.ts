        ...
        "09-03-03": [
            {
                ...
                partner: null,
                department: "Кафедра практической и прикладной информатики",
                text: "Студенты получают теоретическую и практическую подготовку в сфере технологий обработки данных, проектирования, разработки и эксплуатации информационных систем и хранилищ данных, обеспечивающих деятельность и бизнес-процессы государственных структур, производственных и непроизводственных предприятий.\n" +
        ...
        "09-03-04": [
            {
                ...
                direction: null,
                partner: null,
                text: "В ходе обучения студенты получают теоретическую и практическую подготовку в области разработки и эксплуатации программного обеспечения и проектирования информационных систем как совокупности средств, методов и персонала, используемых для хранения, обработки и выдачи информации для целей управления.\n" +
            ...
            },
            {
                ...
                direction: null,
                partner: null,
                text: "В ходе обучения студенты получают теоретическую и практическую подготовку в области стандартизации программной и системной инженерии, а также создания и развития сложных, многоверсионных, тиражируемых программных средств и баз данных высокого качества и надёжности.\n" +
            ...
            },
            {
                ...
                direction: null,
                partner: null,
                text: "Предлагаемый профиль направлен на подготовку профессионалов высшей квалификации, ориентированных на проектирование, разработку, внедрение, сопровождение и эксплуатацию информационных систем корпоративного управления.\n" +
            ...
            },
            {
                ...
                direction: null,
                partner: null,
                text: "В ходе обучения студенты получают теоретическую и практическую подготовку в области создания программного обеспечения на основе интеллектуальных методов и подходов, способного обеспечить поддержку принятия решений\n" +
        ...
        "09-04-01": [
            {
                ...
                direction: null,
                partner: null,
                text: "В ходе обучения студенты получают теоретическую и практическую подготовку в области проектирования, программирования, контроля и обеспечения функционирования элементов, устройств, комплексов и систем обработки данных, в том числе с применением методов интеллектуальной обработки.\n" +
        ...
        "09-04-03": [
            {
                ...
                direction: null,
                partner: null,
                text: "В ходе обучения студенты получают теоретическую и практическую подготовку в области проектирования, построения, внедрения и сопровождения корпоративных информационных систем в прикладных областях, осваивают методики моделирования и совершенствования прикладных и информационных процессов.\n" +
        ...
        "09-04-04": [
            {
                ...
                direction: null,
                partner: null,
                text: "В ходе обучения студенты получают теоретическую и практическую подготовку в сфере анализа, выбора и реализации архитектурных решений при проектировании программного обеспечения и информационно-вычислительных систем различного назначения в контексте их индустриального производства.\n" +
