...
type Props = {
    ...
    element2: {linkImage: StaticImageData,text: string,linkPage: string, position?: boolean | undefined},
...
export default function DownTransition({element1, element2, element3, heading = "ДРУГИЕ ТЕМАТИЧЕСКИЕ СТРАНИЦЫ", side = "center"}: Props) {
    const array = [{
        ...
        linkImage: element2.linkImage, text: element2.text, linkPage: element2.linkPage, alt: element2.text, positionUp: element2.position === undefined ? false : element2.position
    },{
