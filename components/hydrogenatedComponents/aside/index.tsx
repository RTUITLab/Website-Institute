    ...
    <aside className={classNames(Style.Aside, hidden ? Style.NoHidden : Style.Hidden)}>
      <article>
        ...
        <div>
          ...
          <ButtonAside
            targetBlank={true}
            imageLink={RTUITLabWeb}
            link={'https://rtuitlab.dev'}
          ...
          <ButtonAside
            targetBlank={true}
            imageLink={MIREAWeb}
            link={'https://www.mirea.ru/education/the-institutes-and-faculties/institute-of-information-technology/about-the-institute/'}
            text={'Сайт РТУ МИРЭА'}
            onClick={onClick}
          />
        </div>
