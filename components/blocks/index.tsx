    ...
    <article className={classNames(Style.BlockImage, reverse ? Style.DirectionRow : Style.DirectionReverseRow)}>
      ...
      <div>
        ...
        {typeof buttonBasic === 'string' || typeof buttonImportant === 'string' ? (
          <div>
            {buttonImportant === null || buttonImportant === undefined ? (
              <></>
            ) : (
              <ButtonLinkVIKA link={buttonImportant} text={'подробнее'} />
            )}
            {buttonBasic === null || buttonBasic === undefined ? (
              <></>
            ) : (
              <ButtonLinkDefault targetBlank={true} link={buttonBasic} text={'подробнее на сайте рту мирэа'} />
            )}
          </div>
        ) : (
          <></>
