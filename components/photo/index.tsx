        ...
        <div className={Style.SectionPhoto}>
            ...
            <ScrollContainer>
                {images.map((elem, index) =>
                    <button className={classNames(Style.ButtonSwitch, currentImage === index ? Style.ButtonActive : Style.ButtonNoActive)} key={"mini_button_"+index} onClick={() => setCurrentImage(index)}>
