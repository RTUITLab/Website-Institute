...
export default function PageInstitute() {
  ...
  const id = [
    { link: 'structure', text: 'Узнать про институт' },
    { link: 'mission', text: 'Деятельность института' },
    { link: 'partners', text: 'Посмотреть партнёров' },
    { link: 'facts', text: 'Факты о институте' },
    { link: 'entrance', text: 'Узнать про поступление' },
  ];
    ...
    <>
      ...
      <main>
        <Section id={id[0].link}>
          ...
          <div className={Style.InstituteDivCard}>
            ...
            <TextCard
              ...
              text={
                'В отличие от других институтов РТУ МИРЭА, наш институт в первую очередь ориентирован на подготовку студентов в области программирования, разработки программного обеспечения и IT-сферы. При этом мы также уделяем внимание инженерным, математическим и бизнес-информационным наукам, но в меньшей степени. Например, студенты направления "Информатика и вычислительная техника" в основном занимаются разработкой программного обеспечения для различных устройств, а прикладные математики именно занимаются практическим применением математические методов в анализе данных и в области искусственного интеллекта.'
              }
            />
          </div>
        </Section>
        ...
        <Section id={id[4].link}>
          ...
          <AdmissionCard
            buttonOne={{ link: 'https://priem.mirea.ru', text: 'ПРИЁМНАЯ КОММИССИЯ' }}
            buttonTwo={{ link: 'https://www.mirea.ru/education/the-institutes-and-faculties/', text: 'ДРУГИЕ ИНСТИТУТЫ РТУ МИРЭА' }}
            heading={'ПРИЁМНАЯ КОММИССИЯ '}
            text={
              'Поступление в РТУ МИРЭА и Институт информационных технологий осуществляется через приемную комиссию как на платной, так и на бюджетной основе. Подробную информацию о процедуре приема и ее правилах вы можете найти на официальном сайте приемной комиссии.'
            }
