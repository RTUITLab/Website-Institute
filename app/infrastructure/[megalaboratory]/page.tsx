...
import Laba1Image1 from "@/public/image/megalaboratory/1/LR0A1499.webp";
import Laba1Image2 from "@/public/image/megalaboratory/1/LR0A1501.webp";
import Laba1Image3 from "@/public/image/megalaboratory/1/LR0A1502.webp";
import Laba1Image4 from "@/public/image/megalaboratory/1/LR0A1505.webp";
import Laba1Image5 from "@/public/image/megalaboratory/1/LR0A1506.webp";
import Laba1Image6 from "@/public/image/megalaboratory/1/LR0A1507.webp";
import Laba1Image7 from "@/public/image/megalaboratory/1/LR0A1509.webp";
import Laba1Image8 from "@/public/image/megalaboratory/1/LR0A1510.webp";
import Laba1Image9 from "@/public/image/megalaboratory/1/LR0A1511.webp";
import Laba1Image10 from "@/public/image/megalaboratory/1/LR0A1512.webp";
import Laba1Image11 from "@/public/image/megalaboratory/1/LR0A1513.webp";
import Laba1Image12 from "@/public/image/megalaboratory/1/LR0A1515.webp";
import Laba1Image13 from "@/public/image/megalaboratory/1/LR0A1518.webp";
import Laba1Image14 from "@/public/image/megalaboratory/1/LR0A1522.webp";
import Laba1Image15 from "@/public/image/megalaboratory/1/LR0A1524.webp";
import Laba1Image16 from "@/public/image/megalaboratory/1/LR0A1525.webp";
import Laba1Image17 from "@/public/image/megalaboratory/1/LR0A1527.webp";
import Laba1Image18 from "@/public/image/megalaboratory/1/LR0A1531.webp";
import Laba1Image19 from "@/public/image/megalaboratory/1/LR0A1532.webp";
import Laba1Image20 from "@/public/image/megalaboratory/1/LR0A1534.webp";
import Laba1Image21 from "@/public/image/megalaboratory/1/LR0A1536.webp";
import Laba1Image22 from "@/public/image/megalaboratory/1/LR0A1537.webp";
import Laba1Image23 from "@/public/image/megalaboratory/1/LR0A1543.webp";
import Laba1Image24 from "@/public/image/megalaboratory/1/LR0A1546.webp";
import Laba1Image25 from "@/public/image/megalaboratory/1/LR0A1548.webp";
import Laba1Image26 from "@/public/image/megalaboratory/1/LR0A1550.webp";
import Laba1Image27 from "@/public/image/megalaboratory/1/LR0A1551.webp";
import Laba1Image28 from "@/public/image/megalaboratory/1/LR0A1552.webp";
import Laba1Image29 from "@/public/image/megalaboratory/1/LR0A1554.webp";
...
function getApi(params: string)
{
    ...
    const data = {
        laboratory_import_substitution_of_information_technologies: {
            ...
            UsageCardTable: [{image: Default, heading: "Все студенты института информационных технологий могут проходить основное обучение в этой лаборатории.", style: "default"}, {image: DevOps, heading: "Студенты проходящие курс элитной подготовки «Профессия DevOps» от ПАО «Ростелеком», занимаются в этой лаборатории.", style: "rostelecom"} , {image: Database, heading: "Студенты профиля «Инфраструктура информационных технологий» используют техническую базу данной лаборатории при изучении дисциплин профиля.", style: "iio"}, {image: Ind, heading: "Обратившись к соотрудникам института в А-420, студенты могут воспользоваться лабораторным оборудованием под наблюдением соотрудников", style: "vika"}],
            images: [Laba1Image1,Laba1Image2,Laba1Image3,Laba1Image4,Laba1Image5,Laba1Image6,Laba1Image7,Laba1Image8,Laba1Image9,Laba1Image10,Laba1Image11,Laba1Image12,Laba1Image13,Laba1Image14,Laba1Image15,Laba1Image16,Laba1Image17,Laba1Image18,Laba1Image19,Laba1Image20,Laba1Image21,Laba1Image22,Laba1Image23,Laba1Image24,Laba1Image25,Laba1Image26,Laba1Image27,Laba1Image28,Laba1Image29,Laba1Image30,Laba1Image31,Laba1Image32]
        },
        laboratory_technology_analytics_modeling_design_and_digital_prototyping: {
            ...
            UsageCardTable: [{image: Default, heading: "Все студенты института информационных технологий могут проходить основное обучение в этой лаборатории со 2 курса бакалавриата.", style: 'default'}, {image: Ind, heading: "Обратившись к соотрудникам института в А-420, студенты могут воспользоваться лабораторным оборудованием под наблюдением соотрудников", style: 'vika'}],
            images: [Laba2Image1,Laba2Image2,Laba2Image3,Laba2Image4,Laba2Image5,Laba2Image6,Laba2Image7,Laba2Image8,Laba2Image9,Laba2Image10,Laba2Image11]
        },
        laboratory_motion_capture: {
            ...
            equipment: [{linkImage: Mocap_equipment_1, heading: "КОМПЬЮТЕРНАЯ СТАНЦИЯ VICON C ПРОГРАММНЫМ ПАКЕТОМ SHOGUN ДЛЯ ОБРАБОТКИ И ОТСЛЕЖИВАНИЯ МИМИКИ И ДВИЖЕНИЯ ОБЪЕКТОВ ", text: "1 устройство"},{linkImage: Mocap_equipment_2, heading: "КАМЕРЫ ДЛЯ ЗАХВАТА ДВИЖЕНИЯ Vicon Vero", text: "16 устройств"},{linkImage: Mocap_equipment_3, heading: "КОМПЛЕКТ ТРЕКИНГ КОСТЮМА ДЛЯ ЗАХВАТА ДВИЖЕНИЯ", text: "2 комплекта"},{linkImage: Mocap_equipment_4, heading: "ШЛЕМ Mark IV Wireless Headcam System", text: "2 устройства"}],
            UsageCardTable: [{image: Game_Pr, heading: "Студенты профиля «Разработка и дизайн компьютерных игр и мультимедийных приложений» проходят обучение в этой лаборатории.", style: 'default'}, {image: Ind, heading: "Обратившись к соотрудникам института в А-420, студенты могут воспользоваться лабораторным оборудованием под наблюдением соотрудников", style: 'vika'}],
            images: [Laba3Image1, Laba3Image2, Laba3Image3, Laba3Image4, Laba3Image5, Laba3Image6, Laba3Image7, Laba3Image8, Laba3Image9, Laba3Image10, Laba3Image11, Laba3Image12, Laba3Image13, Laba3Image14, Laba3Image15, Laba3Image16, Laba3Image17, Laba3Image18, Laba3Image19, Laba3Image20, Laba3Image21, Laba3Image22, Laba3Image23, Laba3Image24, Laba3Image25, Laba3Image26, Laba3Image27, Laba3Image28, Laba3Image29, Laba3Image30, Laba3Image31, Laba3Image32, Laba3Image33, Laba3Image34, Laba3Image35]
        },
        laboratory_immersive_technologies: {
            ...
            UsageCardTable: [{image: Vr_Pr, heading: "Студенты профиля «Проектирование и разработка сред и приложений дополненной и виртуальной реальностей» проходят обучение в этой лаборатории.", style: 'default'}, {image: Ind, heading: "Обратившись к соотрудникам института в А-420, студенты могут воспользоваться лабораторным оборудованием под наблюдением соотрудников", style: 'vika'}],
            images: [Laba4Image1, Laba4Image2, Laba4Image3, Laba4Image4, Laba4Image5, Laba4Image6, Laba4Image7, Laba4Image8, Laba4Image9, Laba4Image10, Laba4Image11, Laba4Image12, Laba4Image13, Laba4Image14, Laba4Image15, Laba4Image16, Laba4Image17, Laba4Image18, Laba4Image19, Laba4Image20, Laba4Image21, Laba4Image22, Laba4Image23, Laba4Image24, Laba4Image25, Laba4Image26]
        }
    }
...
export default function Megalaboratory({ params } : { params: { megalaboratory: string } }) {
    ...
    return (
        <>
            <Screensaver id={id} positionUp={true} linkImage={data.screensaverImage} text={data.screensaverText} alt={data.screensaverText} />
            <main>
                ...
                <Section id={id[2].link}>
                    ...
                    <UsageCardTable array={data.UsageCardTable} />
                </Section>
