...
function getApi(params: string) {
  const data = {
    laboratory_import_substitution_of_information_technologies: {
      ...
      textUsage: [
        'Комплекс решает две особенно важные в условиях импортозамещения и санкционных ограничений задачи. С одной стороны, он открывает доступ к справочной информации программных и аппаратных средств отечественного производства. А с другой стороны, обеспечивает доступность самого программного обеспечения и компьютерного оборудования национальных производителей. Всё это позволяет повысить эффективность образовательной и исследовательской деятельности и сохранять технологический и кадровый суверенитет государства.',
      ],
      video: 'https://rutube.ru/play/embed/6333a42cef37924320352f054f7ab087',
      specificity: [
        { numberOrImage: Rostelecom_specificity_1, heading: 'Отечественное  оборудование', text: null },
        { numberOrImage: Rostelecom_specificity_2, heading: 'Инженерная зона и оборудование', text: null },
        { numberOrImage: Rostelecom_specificity_3, heading: 'Демонстрационная зона', text: null },
        { numberOrImage: Rostelecom_specificity_4, heading: 'Разработка и сборка роботизированных кибер платформ', text: null },
        { numberOrImage: Rostelecom_specificity_5, heading: 'DevOps инженерия на основе отечественных IT-решений и продуктов', text: null },
        {
          numberOrImage: Rostelecom_specificity_6,
          heading: 'Внедрение и использование отечественных IT-продуктов в сфере кибер безопасности',
          text: null,
        },
        { numberOrImage: Rostelecom_specificity_7, heading: 'Разработка ПО для отечественных ОС и компьютерного оборудования', text: null },
        {
          numberOrImage: Rostelecom_specificity_8,
          heading: 'Разработка и проектирование программных комплексов для IT-инфраструктуры предприятий',
          text: null,
        },
      ],
      equipment: [
      ...
      UsageCardTable: [
        {
          image: Default,
          heading: 'Все студенты института информационных технологий могут проходить основное обучение в этой лаборатории.',
          style: 'default',
        },
        {
          image: DevOps,
          heading: 'Студенты проходящие курс элитной подготовки «Профессия DevOps» от ПАО «Ростелеком», занимаются в этой лаборатории.',
          style: 'rostelecom',
        },
        {
          image: Database,
          heading:
            'Студенты профиля «Инфраструктура информационных технологий» используют техническую базу данной лаборатории при изучении дисциплин профиля.',
          style: 'iio',
        },
        {
          image: Ind,
          heading:
            'Обратившись к соотрудникам института в А-420, студенты могут воспользоваться лабораторным оборудованием под наблюдением соотрудников',
          style: 'vika',
        },
      ],
      images: [
    ...
    laboratory_technology_analytics_modeling_design_and_digital_prototyping: {
      ...
      specificity: [
        { numberOrImage: Kresla_specificity_1, heading: 'Комфортные условия работы', text: null },
        { numberOrImage: Kresla_specificity_2, heading: 'Условия для мультизадачной работы', text: null },
        { numberOrImage: Kresla_specificity_3, heading: 'Моделирование 3D объектов и прототипирование', text: null },
        { numberOrImage: Kresla_specificity_4, heading: 'Разработка программного обеспечения и систем', text: null },
        { numberOrImage: Kresla_specificity_5, heading: 'Анализ, моделирование и проектирование IT продуктов и систем', text: null },
    ...
    laboratory_motion_capture: {
      ...
      specificity: [
        { numberOrImage: Mokap_specificity_1, heading: 'Системы Vicon для захвата движений объектов (MotionCapture)', text: null },
        { numberOrImage: Mokap_specificity_2, heading: 'Системы захвата лицевой мимики Faceware Technologies', text: null },
        { numberOrImage: Mokap_specificity_3, heading: 'Запись анимаций, кат-сцен и фильмов', text: null },
      ],
      equipment: [
        {
    ...
    laboratory_immersive_technologies: {
      ...
      specificity: [
        { numberOrImage: Vr_specificity_1, heading: 'Стенд для одновременной работы до 4 операторов', text: null },
        { numberOrImage: Vr_specificity_2, heading: 'Мощная компьютерная станция для обработки и рендера 3D объектов', text: null },
        { numberOrImage: Vr_specificity_3, heading: 'Оборудование дополненой реальности', text: null },
        { numberOrImage: Vr_specificity_4, heading: 'Оборудование виртуальной реальности', text: null },
        { numberOrImage: Vr_specificity_5, heading: 'Оборудование смешанной реальности', text: null },
...
export default function Megalaboratory({ params }: { params: { megalaboratory: string } }) {
  ...
  const id = [
    { link: 'specificity', text: 'Прочитать про МЕГАЛАБОРАТОРИЮ' },
    { link: 'equipment', text: 'ПОСМОТРЕТЬ ОБОРУДОВАНИЕ' },
    { link: 'usage', text: 'УЗНАТЬ КТО В НЕЙ ЗАНИМАЕТСЯ' },
    { link: 'video', text: 'ПОСМОТРЕТЬ ВИДЕОРОЛИКИ' },
    { link: 'photo', text: 'ПОСМОТРЕТЬ ФОТОГРАФИИ' },
  ];
