        ...
        sections: [
            ...
            elements: [
              {
                ...
                array: [
                  {
                    numberOrImage: Rostelecom_specificity_1,
                    heading: 'Отечественное  оборудование',
                    text: null,
                  },
                  {
                    numberOrImage: Rostelecom_specificity_2,
                    heading: 'Инженерная зона и оборудование',
                    text: null,
                  },
                  {
                    numberOrImage: Rostelecom_specificity_3,
                    heading: 'Демонстрационная зона',
                    text: null,
                  },
                  {
                    numberOrImage: Rostelecom_specificity_4,
                    heading: 'Разработка и сборка роботизированных кибер платформ',
                    text: null,
                  },
                  {
                    numberOrImage: Rostelecom_specificity_5,
                    heading: 'DevOps инженерия на основе отечественных IT-решений и продуктов',
                    text: null,
                  },
                  {
                  ...
                  {
                    numberOrImage: Rostelecom_specificity_7,
                    heading: 'Разработка ПО для отечественных ОС и компьютерного оборудования',
                    text: null,
                  },
                  {
            ...
            elements: [
              {
                ...
                array: [
                  {
                    linkImage: Rostelecom_equipment_1,
                    heading: 'ОТЕЧЕСТВЕННОЕ КОМПЬЮТЕРНОЕ ОБОРУДОВАНИЕ',
                    text: '65+ устройств',
                    position: false,
                  },
                  {
                    linkImage: Rostelecom_equipment_2,
                    heading: 'Демонстрационная зона',
                    text: '1 экран и 20 мест',
                    position: false,
                  },
                  {
                    linkImage: Rostelecom_equipment_3,
                    heading: 'ОТЕЧЕСТВЕННОЕ ИНЖЕНЕРНОЕ ОБОРУДОВАНИЕ',
                    text: '13+ устройств',
                    position: false,
                  },
                  {
                  ...
                  {
                    linkImage: Rostelecom_equipment_5,
                    heading: 'МАЛАЯ ЭКСПЕРЕМЕНТАЛЬНАЯ ШАГАЮЩАЯ ПЛАТФОРМА',
                    text: '6+ устройств',
                    position: false,
                  },
                ],
            ...
            elements: [
              {
                ...
                array: [
                  ...
                  },
                  {
                    image: DevOps,
                    heading:
                      'Студенты проходящие курс элитной подготовки «Профессия DevOps» от ПАО «Ростелеком», занимаются в этой лаборатории.',
                    style: 'rostelecom',
                  },
                  {
                    image: Database,
          ...
          },
          {
            ...
            elements: [
              {
                type: 'video',
                src: 'https://rutube.ru/play/embed/6333a42cef37924320352f054f7ab087',
              },
            ],
          },
          {
                ...
                array: [
                  {
                    ...
                    heading:
                      'КОМПЬЮТЕРНАЯ СТАНЦИЯ VICON C ПРОГРАММНЫМ ПАКЕТОМ SHOGUN ДЛЯ ОБРАБОТКИ И ОТСЛЕЖИВАНИЯ МИМИКИ И ДВИЖЕНИЯ ОБЪЕКТОВ ',
                    text: '1 устройство',
                    position: false,
                  },
                  {
